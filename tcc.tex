%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%      TCC de Maykon da Costa Menezes, 2019     %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Alterado por Prof. Váleria Costa
...
\input{capitulos/fundamentacao-teorica.tex}
\input{capitulos/relacionados.tex}
\input{capitulos/nav-point.tex}
\input{capitulos/metodologia.tex}
\input{capitulos/prototipo-e-testes.tex}
